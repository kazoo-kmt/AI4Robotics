...
def run(param1, param2):
    ...
    N = 100
    crosstrack_error_prev = myrobot.y

    for i in range(N):
        crosstrack_error_curr = myrobot.y
        steering = - param1 * crosstrack_error_curr - param2 * (crosstrack_error_curr - crosstrack_error_prev)
        myrobot = myrobot.move(steering, speed)
        print(myrobot, steering)
        crosstrack_error_prev = crosstrack_error_curr
