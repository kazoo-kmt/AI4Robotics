...
def localize(colors,measurements,motions,sensor_right,p_move):
    ...
    # use measurement and call sense function
    for i in range(len(measurements)):
        p = _move(p, motions[i], p_move)
        p = _sense(p, colors, measurements[i], sensor_right)
...
# test= [[0.01105, 0.02464, 0.06799, 0.04472, 0.02465],
